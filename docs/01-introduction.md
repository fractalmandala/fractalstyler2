...
PS - If you just want to get started, and engage by doing, skip to the next doc - [02-philosophy](./02-philosophy.md)
...
You'll get the feel for Fractalstyler quickly, with just one heuristic - 
...
So Fractalstyler isn’t my system or *a* system. It’s actually your system, built to operate the way you want your styling to operate. What it ensures is:
